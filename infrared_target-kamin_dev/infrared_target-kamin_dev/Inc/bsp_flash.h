...
#define FLASH_PAGE_SIZE     0x800                                               //flash page 2Kbyte  STM32F303CB
#define FLASH_MAX_SIZE      0x40000                                             //the size of flash is 256kb
#define FLASH_MAX_PAGE      0x40                                                //the page of flash is 128
...
*********************************************************************************************************
*/
uint16_t bsp_flash_get_sector(uint32_t addr);							        //获取指定地址所在flash的块首地址
...
int bsp_flash_write_words(uint32_t addr, void *p_data, uint32_t wordNum);
